...
Details of this package (background, algorithm, usage, etc.) will be described in the article below:
...
(This method uses the distribution of brightness values in the input image to extract each BS feature. The distribution (variance) of brightness values changes as only pixels within the masked region are included in the calculation, thereby changing the criteria for high and low amplitude, which in turn changes the BS features.)
